  ...
  const columns = [
    {
      ...
      key: "pathImg",
      render: (value) => {
        return <img width={"100px"} height={"100px"} src={value} alt="1" />;
      },
    },
    {
      title: "Tên sản phẩm",
    ...
    },
    {
      ...
      render: (render) => {
        return (
          <Button ghost danger onClick={() => removeProductFromCart(render.id)}>
            Xóa
          </Button>
        );
      },
            ...
            <Col lg="3">
              <div style={{ display: "flex" }}>
                ...
                <h6 className="d-flex align-items-center justify-content-between">
                  <span className="fs-4 fw-bold">{VND.format(summary)}</span>
                </h6>
              </div>
              <p className="fs-6 mt-2">
                <i>*Thuế và phí vận chuyển sẽ được tính khi thanh toán</i>
              </p>
              <div>
