      ...
      >
        <Card title="HÌNH THỨC VẬN CHUYỂN">
          <Radio.Group onChange={onChange} value={isTransport}>
            <Radio value={true}>Giao hàng siêu tốc +30.000đ</Radio>
            <p style={{ marginBottom: "10px" }}>
              Đơn hàng của bạn sẽ được vận chuyển trong thời gian 1-2 ngày làm
              việc.
            </p>
            <Radio value={false}>Giao hàng tiết kiệm +0đ</Radio>
            <p style={{ marginBottom: "10px" }}>
              Chúng tôi sẽ liên hệ bạn sớm nhất trong thời gian có thể. Đơn hàng
              của bạn sẽ được vận chuyển trong thời gian 5-6 ngày làm việc.
            </p>
          </Radio.Group>
        </Card>
        <Card title="HÌNH THỨC THANH TOÁN" style={{ marginTop: "20px" }}>
          <Radio.Group onChange={onChangePayment} value={isPayment}>
            ...
            <p>
              Nhân viên sẽ liên lạc với bạn và giao hàng. Bạn sẽ trực tiếp thanh
              toán với nhân viên giao hàng.
            </p>
          </Radio.Group>
        </Card>
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={10} offset={4}>
            {isPayment ? (
              ...
              <Button block type="primary" onClick={() => onSuccess(0)}>
                THANH TOÁN
              </Button>
            )}
          </Col>
